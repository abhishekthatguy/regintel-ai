...
- [x] CRM tool passes the full write-safety checklist — `crm_lookup` + `crm_case_create` behind `CRMAdapter`; writes complete the checklist (validation/duplicates/confirmation/idempotency/audit) in Phase 6
